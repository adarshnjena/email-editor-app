...
const useStyles = makeStyles((theme) => ({
  ...
  historyGroup: {
    ...
    '&:hover': {
      background:
        'linear-gradient(135deg, rgba(117, 117, 117, 0.15) 0%, rgba(66, 66, 66, 0.15) 100%)',
    },
  },
  actionGroup: {
    ...
    '&:hover': {
      background:
        'linear-gradient(135deg, rgba(117, 117, 117, 0.15) 0%, rgba(97, 97, 97, 0.15) 100%)',
    },
  },
  button: {
    ...
    '&::before': {
      ...
      bottom: 0,
      background:
        'linear-gradient(135deg, rgba(66, 66, 66, 0.1) 0%, rgba(117, 117, 117, 0.1) 100%)',
      opacity: 0,
      ...
      <div className={classes.root}>
        ...
        >
          ...
          >
            <MaterialButton
              className={`${classes.button} ${
                activeAction === 'undo' ? classes.pulseAnimation : ''
              }`}
              disabled={!canUndo}
              onClick={() => {
                if (canUndo) {
          ...
          >
            <MaterialButton
              className={`${classes.button} ${
                activeAction === 'redo' ? classes.pulseAnimation : ''
              }`}
              disabled={!canRedo}
              onClick={() => {
                if (canRedo) {
        ...
        >
          ...
          >
            <MaterialButton
              className={`${classes.button} ${
                activeAction === 'preview' ? classes.pulseAnimation : ''
              }`}
              onClick={() => {
                onPreviewOpen();
                setActiveAction('preview');
          ...
          >
            <MaterialButton
              className={`${classes.button} ${
                activeAction === 'html' ? classes.pulseAnimation : ''
              }`}
              onClick={() => {
                onHtmlOpen();
                setActiveAction('html');

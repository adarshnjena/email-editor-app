...
export function ExportImportDialog({ 
    ...
    const handleExportJSON = async () => {
        try {
            ...
            setMessage({ type: 'error', text: 'Failed to export JSON: ' + error.message });
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleExportHTML = async () => {
        try {
            ...
            setMessage({ type: 'error', text: 'Failed to export HTML: ' + error.message });
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleExportEmailTemplate = async () => {
        try {
            ...
            setMessage({ type: 'error', text: 'Failed to export email template: ' + error.message });
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleImportJSON = async () => {
        try {
            setLoading(true);
            const result = await exportImportService.importFromJSON();
                ...
                <Box className={classes.section}>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={4}>
                            <Paper 
                                className={classes.actionCard}
                                onClick={handleExportEmailTemplate}
                                disabled={loading}
                            >

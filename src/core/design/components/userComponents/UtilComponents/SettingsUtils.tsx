          ...
          <Box m={1} mt={2}>
            ...
            <TextField
              ...
              onChange={(e) => {
                ...
                setProp(
                  (prop) =>
                    (prop.props.linkTarget = e.target.value === 'New Tab' ? '_blank' : '_self')
                );
              }}
              fullWidth
    ...
    <CustomAccordion
      ...
      preview={
        isBgImage ? (
          ...
          <CustomColorButton value={getBg(false)} title="Background Color" />
        )
      }
      children={
        <>
          {
            <Box display="flex" alignItems="center" m={1}>
              <Typography variant="subtitle2" color={!isBgImage ? 'textPrimary' : 'textSecondary'}>
                Color
              </Typography>
              <Switch
                size="small"
            ...
            <Box mt={2} m={1}>
              ...
              <TextField
                ...
                onChange={(e) => {
                  e.persist();
                  setProp((prop) => {
                    if (e.target.value !== '') setBg(true, prop, e.target.value);

...
export function ViewPreviewDialog({
  previewDoc,
  onClose,
  title,
}: ViewPreviewDialogProps): JSX.Element {
  ...
  useEffect(() => {
    ...
    setState({
      data: newObj.data,
      template: template as (data: any) => string,
      previewDoc: previewDoc,
    });
  }, [previewDoc]);
  ...
  return (
    ...
    >
      ...
      <DialogContent dividers>
        ...
        >
          <Alert
            severity={snackbar['props']['variant'] ? snackbar['props']['variant'] : 'success'}
            style={{
              width: 250,
            }}
          >
